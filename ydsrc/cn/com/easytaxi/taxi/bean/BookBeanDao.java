...
public class BookBeanDao extends AbstractDao<BookBean, Long> {
	...
	public static class Properties {
		...
		public final static Property ForecastDistance = new Property(25, String.class, "forecastDistance", false, "FORECAST_DISTANCE");
		...
		public final static Property ForecastPrice = new Property(29, String.class, "forecastPrice", false, "FORECAST_PRICE");
		public final static Property CALLEDNUMBER = new Property(30, String.class, "called_number", false, "CALLED_NUMBER");
		public final static Property LEVEL = new Property(31, String.class, "levels", false, "LEVEL");
		public final static Property CX = new Property(32, String.class, "cx", false, "CX");
		public final static Property REASON = new Property(33, String.class, "reason", false, "REASON");
		public final static Property ISPL = new Property(34, Integer.class, "isPl", false, "IS_PL");
		public final static Property TIMELONG = new Property(35, String.class, "timeLong", false, "TIME_LONG");
		public final static Property CANCELLATIONTIME = new Property(36, String.class, "cancellation_time", false, "CANCELLATION_TIME");
		public final static Property AVATARIMAGE = new Property(37, String.class, "avatarImage", false, "AVATAR_IMAGE");
		public final static Property LPRESULT = new Property(38, Integer.class, "plResult", false, "PL_RESULT");
		public final static Property FEE = new Property(39, String.class, "fee", false, "fee");
		public final static Property FUTUREFEE = new Property(40, String.class, "futurefee", false, "FUTUREFEE");
		public final static Property CARCOLOR = new Property(41, String.class, "carColor", false, "CARCOLOR");
	};
	...
	public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
		...
		db.execSQL("CREATE TABLE " + constraint + "'BOOK_BEAN' (" + //
				...
				"'FORECAST_DISTANCE' TEXT," + // 25: forecastDistance
				...
				"'AVATAR_IMAGE' TEXT," + //
				"'PL_RESULT' INTEGER," + "'FEE' TEXT," + "'FUTUREFEE' TEXT," + "'CARCOLOR' TEXT" + ");"); // 29:
																											// forecastPrice
	}
	...
	protected void bindValues(SQLiteStatement stmt, BookBean entity) {
		...
		String forecastDistance = entity.getForecastDistance();
		if (forecastDistance != null) {
			stmt.bindString(26, forecastDistance);
		}
		...
		String forecastPrice = entity.getForecastPrice();
		if (forecastPrice != null) {
			stmt.bindString(30, forecastPrice);
		}
		String called_number = entity.getCalled_number();
		if (called_number != null) {
			stmt.bindString(31, called_number);
		}
		String level = entity.getLevel();
		if (level != null) {
			stmt.bindString(32, level);
		}
		String cx = entity.getCx();
		if (cx != null) {
			stmt.bindString(33, cx);
		}
		String reason = entity.getReason();
		if (reason != null) {
			stmt.bindString(34, reason);
		}
		Integer isPl = entity.getIsPl();
		if (isPl != null) {
			stmt.bindLong(35, isPl);
		}
		String timeLong = entity.getTimeLong();
		if (timeLong != null) {
			stmt.bindString(36, timeLong);
		}
		String cancellation_time = entity.getCancellation_time();
		if (cancellation_time != null) {
			stmt.bindString(37, cancellation_time);
		}
		String avatarImage = entity.getAvatarImage();
		if (avatarImage != null) {
			stmt.bindString(38, avatarImage);
		}
		Integer plResult = entity.getPlResult();
		if (plResult != null) {
			stmt.bindLong(39, plResult);
		}
		String fee = entity.getFee();
		if (plResult != null) {
			stmt.bindString(40, fee);
		}
		String futurefee = entity.getFuturefee();
		if (plResult != null) {
			stmt.bindString(41, futurefee);
		}
		String carColor = entity.getCarColor();
		if (plResult != null) {
			stmt.bindString(42, carColor);
		}
	}
	...
	public BookBean readEntity(Cursor cursor, int offset) {
		...
		//
				...
				cursor.isNull(offset + 25) ? null : cursor.getString(offset + 25), // forecastDistance
				...
				cursor.isNull(offset + 29) ? null : cursor.getString(offset + 29), // forecastPrice
				cursor.isNull(offset + 30) ? null : cursor.getString(offset + 30),// forecastPrice
				cursor.isNull(offset + 31) ? null : cursor.getString(offset + 31), // forecastPrice
				cursor.isNull(offset + 32) ? null : cursor.getString(offset + 32), // forecastPrice
				cursor.isNull(offset + 33) ? null : cursor.getString(offset + 33), // forecastPrice
				cursor.isNull(offset + 34) ? null : cursor.getInt(offset + 34),// forecastPrice
				cursor.isNull(offset + 35) ? null : cursor.getString(offset + 35), // forecastPrice
				cursor.isNull(offset + 36) ? null : cursor.getString(offset + 36), // forecastPrice
				cursor.isNull(offset + 37) ? null : cursor.getString(offset + 37), // forecastPrice
				cursor.isNull(offset + 38) ? null : cursor.getInt(offset + 38), // forecastPrice
				cursor.isNull(offset + 39) ? null : cursor.getString(offset + 39), // forecastPrice
				cursor.isNull(offset + 40) ? null : cursor.getString(offset + 40), // forecastPrice
				cursor.isNull(offset + 41) ? null : cursor.getString(offset + 41) // forecastPrice
		);
	...
	public void readEntity(Cursor cursor, BookBean entity, int offset) {
		...
		entity.setForecastDistance(cursor.isNull(offset + 25) ? null : cursor.getString(offset + 25));
		...
		entity.setForecastPrice(cursor.isNull(offset + 29) ? null : cursor.getString(offset + 29));
		entity.setCalled_number(cursor.isNull(offset + 30) ? null : cursor.getString(offset + 30));
		entity.setLevel(cursor.isNull(offset + 31) ? null : cursor.getString(offset + 31));
		entity.setCx(cursor.isNull(offset + 32) ? null : cursor.getString(offset + 32));
		entity.setReason(cursor.isNull(offset + 33) ? null : cursor.getString(offset + 33));
		entity.setIsPl(cursor.isNull(offset + 34) ? null : cursor.getInt(offset + 34));
		entity.setTimeLong(cursor.isNull(offset + 35) ? null : cursor.getString(offset + 35));
		entity.setCalled_number(cursor.isNull(offset + 36) ? null : cursor.getString(offset + 36));
		entity.setAvatarImage(cursor.isNull(offset + 37) ? null : cursor.getString(offset + 37));
		entity.setPlResult(cursor.isNull(offset + 38) ? null : cursor.getInt(offset + 38));
		entity.setFee(cursor.isNull(offset + 39) ? null : cursor.getString(offset + 39));
		entity.setFuturefee(cursor.isNull(offset + 40) ? null : cursor.getString(offset + 40));
		entity.setCarColor(cursor.isNull(offset + 40) ? null : cursor.getString(offset + 41));
	}
