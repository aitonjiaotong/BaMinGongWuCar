...
public class BadgeView extends TextView {
	...
	public void setStaticParams(int widht,int height){
		this.staticWidth = widht;
		this.staticHeight = height;
	}
	
	private void applyLayoutParams() {

		FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(staticWidth != 0 ? staticWidth : LayoutParams.WRAP_CONTENT, staticHeight != 0 ? staticHeight : LayoutParams.WRAP_CONTENT);
