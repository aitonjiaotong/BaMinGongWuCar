...
public class BookHistoryBaseFragement extends BaseFragement {
	...
	public MainActivity bookParent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bookParent = (MainActivity) getActivity();
						...
						if (param != null) {
							...
							if (jsonObject.getInt("error") == 0) {
								...
								for (int i = 0; i < length; i++) {
									...
									// bookBean.setForecastPrice(getJsonInt(jsonObjectBookBean,
									// "forecastPrice"));
									...
									// bookBean.setForecastDistance(getJsonInt(jsonObjectBookBean,
									// "forecastDistance"));
									bookBean.setId(getJsonLong(jsonObjectBookBean, "_ID"));
									// bookBean.setPreTime(getJsonString(jsonObjectBookBean,
									// "currentDate"));
									bookBean.setStartLatitude(getJsonInt(jsonObjectBookBean, "_START_LATITUDE"));
									// bookBean.setEndLatitude(getJsonInt(jsonObjectBookBean,
									// "endLat"));
									...
									// "_REPLYER_COMPANY"));
									// bookBean.setReplyTime(getJsonString(jsonObjectBookBean,
									// "replyTime"));
									// bookBean.setPriceMode(getJsonInt(jsonObjectBookBean,
									// "priceMode"));
									// bookBean.setPrice(getJsonInt(jsonObjectBookBean,
									// "earnst"));
									// bookBean.setPrice(getJsonInt(jsonObjectBookBean,
									// "earnst"));
									bookBean.setBookFlags(getJsonInt(jsonObjectBookBean, "_BOOK_FLAGS"));
									bookBean.setIsPl(getJsonInt(jsonObjectBookBean, "isPl"));
									bookBean.setCalled_number(getJsonString(jsonObjectBookBean, "called_number"));
									...
									bookBean.setForecastPrice(getJsonString(jsonObjectBookBean, "forecastPrice"));
