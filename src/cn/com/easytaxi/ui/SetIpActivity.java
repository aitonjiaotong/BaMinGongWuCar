...
//				 
				...
				ToastUtil.show(SetIpActivity.this, ConfigUtil.getString("IP")+ ","+ ConfigUtil.getInt("TCP_PORT_30"));
				ToastUtil.show(SetIpActivity.this, cn.com.easytaxi.platform.common.common.Config.SERVER_IP );
