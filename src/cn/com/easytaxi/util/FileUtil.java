...
public class FileUtil {
	 ...
	 * 
	 * @return
	 *      bugs not suit for sdk4.4, it will be null
	 */
	...
	private static final String[][] MIME_MapTable = {
			...
			// {".xml", "text/xml"},
			{ ".xml", "text/plain" }, { ".z", "application/x-compress" }, { ".zip", "application/zip" }, { ".amr", "audio/*" }, { "", "*/*" } };
