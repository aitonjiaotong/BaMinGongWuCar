...
public abstract class YdLocaionBaseActivity extends YdBaseActivity {
	...
	protected void requestNearbyTaxi(int carstate,Callback<Object> callback) {
		NewNetworkRequest.getNearbyTaxis(carstate,getUserPhoneNum(), getCurrentlat(), getCurrentLng(), callback, getCityId());
	}
	...
	public void setLocReveive(LocationReceive listener) {
		LocationBroadcastReceiver.setReceiveListener(listener);
	}
