			...
			public void run() {
				while (isLoop) {
					try {
						...
						// AppLog.LogD("====---9999999--udp----------------s msg ----  1 :"
						// + isLoop );
						if (sendMsgBean == null)
							continue;
						// AppLog.LogD("====---9999999--udp----------------s msg ----  2 :"
						// + isLoop );
						sendMsgBean.setId(id);
						// AppLog.LogD("====---9999999--udp----------------s msg ----  3 :"
						// + isLoop );
						...
						// AppLog.LogD("====---9999999--udp----------------s msg ----  4 :"
						// + isLoop );
						...
						try {
							...
							if (sendMsgBean.getTtl() < sendMsgBean.getSendCount()) {
								...
								// AppLog.LogD("====-----999999999  send udp----  "
								// + Integer.toHexString(sendMsgBean.getMsgId())
								// + " , " );
						...
						if (handleListener.isThread()) { // 单独启动一个线程来处理
							new Thread() {
								...
								public void run() {
									...
									// AppLog.LogD("====-----udp--receive msg ----  "
									// +
									// Integer.toHexString(headBean.getMsgId())
									// + " , " );
