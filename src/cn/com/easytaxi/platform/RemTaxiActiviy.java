...
public class RemTaxiActiviy extends YdLocaionBaseActivity {
	...
	public static final String[] CONTACT_PROJECTION = new String[] { Contacts._ID, Contacts.DISPLAY_NAME, Contacts.HAS_PHONE_NUMBER, Contacts.PHOTO_ID };
		...
		public void handleMessage(android.os.Message msg) {
			if (msg.arg1 == 100) {
				...
				if (TextUtils.isEmpty(res)) {
					ToastUtil.show(RemTaxiActiviy.this, "网络不给力");
					// startSendRemdInfo();
				} else {
					requestMyRmdinfo();
		...
		rmd_send.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				if (TextUtils.isEmpty(text)) {
					ToastUtil.show(RemTaxiActiviy.this, "请输入您被推荐人号码");
				}
	...
	protected void uploadRemdInfo(int type) {
		...
		// String sendPeople =
		// getPeoplenums();//rmd_name.getText().toString().replaceAll(" ", "");
	...
	protected void uiContinue() {
		...
		rmd_send.post(new Runnable() {
			...
			public void run() {
				...
				rmd_send.setText("推荐");
				ToastUtil.show(RemTaxiActiviy.this, "服务器已接受到您的推荐信息");
				rmd_name.setText("");
			}
		});
	}
	...
	public static class ContactListAdapter extends CursorAdapter implements Filterable {
		...
		public void bindView(View view, Context context, Cursor cursor) {
			...
			Cursor c = mContent.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, new String[] { ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME, ContactsContract.CommonDataKinds.Phone.NUMBER }, Phone.CONTACT_ID + " = " + cursor.getInt(COLUMN_CONTACT_ID), null, null);
		...
		public String convertToString(Cursor cursor) {
			//
			// Cursor c =
			// mContent.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI,
			// new String[] {
			// ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME,
			// ContactsContract.CommonDataKinds.Phone.NUMBER }, Phone.CONTACT_ID
