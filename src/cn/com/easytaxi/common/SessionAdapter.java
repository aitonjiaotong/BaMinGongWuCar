...
public class SessionAdapter {
	...
	public SessionAdapter(Context context) {
		mContext = context;
		dh = new SessionHelper(mContext, DB_NAME, null, 8); // old is 3 ,now is
															// 4 20130321 add
															// pois history 5
															// add type 6
	...
	//		AppLog.LogD("================= savePoi " + selectedGeoPoint.getName());
		...
		long lat = selectedGeoPoint.getLat();
		long lng = selectedGeoPoint.getLog();
		String sityName=selectedGeoPoint.getCityName();
...
//				AppLog.LogD("SESSION", " == name " + name);
				GeoPointLable gp = new GeoPointLable(lat, log, name,cityName);
				data.add(gp);
			}
		}
