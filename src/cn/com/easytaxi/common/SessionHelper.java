...
public class SessionHelper extends SQLiteOpenHelper {
	...
	private void create(SQLiteDatabase db) {
		...
		db.execSQL("create table t_pois(_ID INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT 1,type integer,_CITY_NAME varchar(32), _MOBILE varchar(32) ,POI varchar(32),CITY_NAME varchar(32) , LAT integer, LNG integer )");
