...
public class BookBean implements Serializable {
	...
	public String toString() {
		...
		sb.append("called_number:").append(calledNumber).append(", ");
		sb.append("levels:").append(level).append(", ");
		sb.append("cx:").append(cx).append(", ");
		sb.append("reason:").append(reason).append(", ");
		sb.append("isPl:").append(isPl).append(", ");
		sb.append("timeLong:").append(timeLong).append(", ");
		sb.append("cityName:").append(cityName).append(" ,");
		sb.append("avatarImage:").append(avatarImage).append(" ,");
		sb.append("plResult:").append(plResult).append(" ,");
		sb.append("currentDate:").append(currentDate).append(", ");
		sb.append("fee:").append(fee).append(", ");
		sb.append("futurefee:").append(futurefee).append(" ");
		sb.append("]");
		return sb.toString();
	...
	class ProgressTimeTask extends TimerTask {
		...
		public void run() {
			...
			if (progress >= timeOut) {
				...
				dispStat = Config.STATE_DIAODUZHONG;// BOOK_STAT_REBOOK;
