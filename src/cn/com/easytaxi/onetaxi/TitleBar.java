...
public class TitleBar implements OnClickListener {
	...
	private Callback<Object> backCallback, rightCallback;
	...
	public void setRightCallback(Callback<Object> rightCallback) {
	...
	public TitleBar(Activity activity) {
		...
		// rightButton = (Button)
		// activity.findViewById(R.id.map_title_right_spinner);
...
//		}
	...
	/*
	 * public void switchToHomeButton() { type = HOME;
	 * rightButton.setVisibility(View.GONE); rightButton = rightHomeButton;
	...
	public void switchToCityButton() {
		...
		rightButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO Auto-generated method stub
				/*
				 * Window.selectCity(mActivity, session, new
				 * Callback<JSONObject>() {
				 * 
				 * @Override public void handle(JSONObject json) { try {
				 * session.set("_CITY_NAME", json.getString("_NAME"));
				 * session.set("_CITY_ID", json.getString("_ID")); Intent intent
				 * = new Intent("cn.com.easytaxi.cityswitch");
				 * mActivity.sendBroadcast(intent); } catch (Throwable e) {
				 * e.printStackTrace(); } } });
				 */
			}
		});
